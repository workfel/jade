...
(function () {
    ...
    angular
        .module('jadeApp')
        .controller('ComponentAddCtrl', ComponentAddCtrl);

    ComponentAddCtrl.$inject = ['$scope', 'PluginsService', 'UtilsService', '$mdSidenav', 'WidgetAddService'];

    function ComponentAddCtrl($scope, PluginsService, UtilsService, $mdSidenav, WidgetAddService) {
