...
(function () {
    ...
    function getTemplate(element, attr) {
        var tmp =
            '<a class="md-primary md-raised md-button md-default-theme widget-content-land" style="background-color: {{widget.color}}" ng-click="onWidgetClicked(widget)" aria-label="{{widget.name}}" >' +
            '<div layout="column">' +
